...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    mXbox.leftBumper().onTrue(new CannonRevolveSpinLimit(mCannonRevolve, -1, -0.4).withTimeout(5.0));
    mXbox.rightBumper().onTrue(new CannonRevolveSpinLimit(mCannonRevolve, 1, 0.4).withTimeout(5.0));
  }
